        ...
        switch (this._load) {
            ...
            case -2:
                if(this._origin._time>60) {
                    ...
                    this._origin._origin.stopSound(1)
                }
                break
            case 0: this.run()
                break
    ...
    _.Console.prototype.readyLoadBit = function () {
        ...
        for(let key of $dataScript.performer){
            if($dataRole[key]){
                ...
                this._origin._origin.loadBitmap("s_"+key,["img/faces/",$dataRole[key].img,0,true])
            }
        }
    }
    ...
    _.Console.prototype.execute =function (com){
        switch (com.id){
            ...
            case 75://设置动作属性
                ...
                break
            case 100://设置图像位图
                this._origin._origin.exFun(['#setBit','s_stage_'+com.data[0],com.data[1],"s_"+com.data[2]])
                break
            case 101://激活图像
